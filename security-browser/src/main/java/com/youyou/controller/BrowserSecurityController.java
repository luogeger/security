...
import com.youyou.config.SecurityYml;
...
public class BrowserSecurityController {
    ...
    public Response browserAccessControl(HttpServletRequest req, HttpServletResponse res) throws IOException {
        ...
        if (savedRequest != null) {
            ...
            System.out.println(securityYml.getBrowserYml().toString());
            if (StringUtils.endsWithIgnoreCase(url, ".html")) {
                redirectStrategy.sendRedirect(req, res, securityYml.getBrowserYml().getLoginPage());// 重定向到login.html
            }
        }
